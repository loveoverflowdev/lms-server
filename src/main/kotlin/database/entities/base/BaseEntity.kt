package database.entities.base
...
abstract class BaseTable(name: String) : IdTable<String>(name) {
...
abstract class BaseEntity(id: EntityID<String>, table: BaseTable) : Entity<String>(id) {
    val createdAt by table.createdAt
    var updatedAt by table.updatedAt
}

abstract class BaseIntEntityClass<E : BaseEntity>(table: BaseTable) : EntityClass<String, E>(table){
    init {
